...
export default function TeacherAlbum() {
  ...
  return (
    <TeacherLayout
        ...
        imageSrc={daramgi} 
    >
      <div className="relative w-full lg:mt-[85px] mt-[120px] px-4 lg:px-[150px] flex flex-col items-center">
        {!loading && (
        ...
        <div className={`h-[470px] flex flex-row items-center ${images.length === 0 || loading ? 'justify-center' : 'justify-between'} w-full`}>
          {!loading && (
