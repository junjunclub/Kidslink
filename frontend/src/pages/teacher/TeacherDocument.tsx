...
export default function TeacherDocument() {
  ...
  return (
    <TeacherLayout
        ...
        imageSrc={daramgi} 
    >
      <div className="relative w-full lg:my-8 mt-16 px-4 lg:px-24 flex flex-col lg:flex-row justify-between">
        <div className="rounded-[20px] bg-[#f4f4f4] lg:w-[360px] w-full lg:h-[500px] h-[300px] p-[15px] mb-5 lg:mb-0">
          ...
          <div className="bg-[#f4f4f4] lg:w-[340px] w-full lg:h-[350px] h-[230px] overflow-y-auto custom-scrollbar">
        ...
        <div className='border-[#B2D170] border-[3px] rounded-[20px] lg:w-[calc(100%-380px)] w-full p-[15px]'>
