...
export default function ParentAlbumDecorate() {
  ...
  const [sticker, setSticker] = useState(null); // 스티커 상태 추가
  const [text, setText] = useState(''); // 추가된 텍스트 상태
  const [editing, setEditing] = useState(false); // 텍스트 편집 상태
